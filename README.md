...
You can enable Advanced plugins section in `ngx-scully-blog/scully.ngx-scully-blog.config.ts` file to support lazy load images, create sitemap, create RSS feed, minify html, optimize SEO href.
